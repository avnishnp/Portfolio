      ...
      <div className="container-custom">
        ...
        <div className="flex flex-col items-center md:items-start gap-6 md:gap-8">
          <div className="w-full text-center md:text-left">
            ...
            <p className="text-base sm:text-lg mb-4 text-gray-700 dark:text-gray-300">
              My expertise lies in building end-to-end pipelines using advanced 3D vision techniques like SLAM,
              Structure from Motion, Pose Estimation, and Depth Estimation,
              with research and industry experience.
            </p>
            <p className="text-base sm:text-lg mb-4 text-gray-700 dark:text-gray-300">
              I am passionate about leveraging 3D vision and deep learning to develop innovative solutions
              that bridge the gap between research and real-world applications.
            </p>
            <div className="flex flex-wrap gap-4 mt-6 justify-center md:justify-start">
              <a
                href="https://www.linkedin.com/in/avnish-patel07"
                target="_blank"
              ...
              <a
                href="https://www.github.com/avnishnp"
                target="_blank"
                rel="noopener noreferrer"
